        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <a href="{{route('about-features')}}">Shuttle About View</a>
                        <i class="fa fa-arrow-right"></i>
                    </li>
                    <li>
                        <p>New Shuttle About</p>
                    </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">Ahuttle About Add</h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <div class="row">
                <div class="col-md-6 ">
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form role="form" action="{{ route('about-features-update') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    ...
                                    <div class="form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                                        ...
                                        <img id="home-img-tag" style="width: 78px;height: 74px; margin-left: 54px;margin-bottom: 18px;margin-top: 21px;"
                                             src="{{ asset('/uploads/about_shuttle/'. $data->image ) }}"  alt="" />
                                ...
                                <div class="form-actions">
                                    ...
                                    <button type="button" class="btn default"><a href="{{route('about-features')}}">Cancel</a></button>
                                </div>
                            </form>
                        </div>
                    </div>
