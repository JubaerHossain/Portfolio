        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <a href="{{route('about-features')}}">About Shuttle View</a>
                        <i class="fa fa-arrow-right"></i>
                    </li>
                    <li>
                        <p>New About Shuttle</p>
                    </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title"> About Shuttle Add</h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <div class="row">
                <div class="col-md-6 ">
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body form">
                            <form role="form" action="{{ route('about-features-store') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
