...
<div class="content">
    ...
    <form class="login-form" action="#" method="post" {{ route('login') }} aria-label="{{ __('Login') }}">
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off"  name="email"  /> </div>
        <div class="form-group">
    ...
    <form class="register-form" action="{{ route('register') }}" method="post">
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Firebase_uid</label>
            <input class="form-control placeholder-no-fix" type="text" placeholder="City/Town" name="firebase_uid" />
        </div>
        <div class="form-actions">
