...
<div class="content">
    ...
    <form class="register-form" action="{{ route('register') }}" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control placeholder-no-fix{{ $errors->has('name') ? ' is-invalid' : '' }}" type="text" placeholder="name"  name="name"/>
            @if ($errors->has('name'))
        ...
        <div class="form-group">
            ...
            <input class="form-control placeholder-no-fix{{ $errors->has('email') ? ' is-invalid' : '' }}" type="text" placeholder="Email"  name="email" required/>
            @if ($errors->has('email'))
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group">
            ...
            <input class="form-control placeholder-no-fix{{ $errors->has('password') ? ' is-invalid' : '' }}" type="password" placeholder="password" name="password" required/>
